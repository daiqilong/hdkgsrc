...
public class WeatherForecastAction {
	private final Log logger = LogFactory.getLog(WeatherForecastAction.class);
	...
	public String weatherInfo(HttpSession session, HttpServletRequest request, HttpServletResponse response, Model model) {
		return  "/rd/hdkg-weather";
	}
