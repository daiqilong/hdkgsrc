...
import com.whir.portal.service.StrBinaryTurn;
	...
	public class Copy_2_of_ServerPortListener implements ServletContextListener {
...
//							String content = StrBinaryTurn.hex2bin(str.substring(0, 2));
					        ...
					        if (startIndex != -1 && endIndex != -1)//存在一次完整的xml数据
					        {
					            ...
					            if(listMap.size()==10){
					            	if(putDateToDataBase(listMap)){
					            		listMap=listMap.subList(10, listMap.size());
					            	}
					            }
					        }
...
//				e.printStackTrace();
		  ...
		  public boolean putDateToDataBase(List<Map<String,String>> listMap){
			  boolean flag = false;
